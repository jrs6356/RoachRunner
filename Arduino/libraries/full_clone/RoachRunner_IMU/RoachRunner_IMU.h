#ifndef _ROACHRUNNERIMU_H_INCLUDED
#define _ROACHRUNNERIMU_H_INCLUDED
...
typedef void (IMU::*lsm9ds1_read_func)(void);
typedef void (IMU::*lsm9ds1_get_event_func)(sensors_event_t *,uint32_t);
typedef void (IMU::*lsm9ds1_get_sensor_func)(sensor_t *);

class IMU {
public:
  IMU(int8_t xmcs, int8_t gcs, int8_t esdo, MUX* _mux, int32_t sensorID = 0);
  ...
  public:
    ...
    Sensor(IMU *parent, lsm9ds1_read_func readFunc,
