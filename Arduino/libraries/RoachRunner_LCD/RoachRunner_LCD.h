...
public:
  ...
  void makeExtraChars2(void);
  void makeEmojis(void);
  ...
  //Create a copy of mux and dpot
  MUX* mux;
  Digipot* dpot;
  
	//Backlight Relay MUX Assignments //A3|A2|A1|A0
  byte lcd_bckl_off = 32;	//0		//0000
  byte lcd_bckl_on = 45;	//13	//1101
  byte lcd_r1_off = 33;		//1		//0001
  byte lcd_r1_on = 44;		//12	//1100
  byte lcd_r2_off = 34;		//2		//0010
  byte lcd_r2_on = 43;		//11	//1011
  byte lcd_r3_off = 35;		//3		//0011
  byte lcd_r3_on = 42;		//10	//1010
  byte lcd_r4_off = 36;		//4		//0100
  byte lcd_r4_on = 41;		//9		//1001
  byte lcd_r5_off = 37;		//5		//0101
  byte lcd_r5_on = 40;		//8		//1000
  byte lcd_r6_off = 38;		//6		//0110
  byte lcd_r6_on = 39;		//7		//0111
  ...
  uint8_t selDot = 0x01;
  uint8_t onDot = 0x02;
  uint8_t deselDot = 0x03;
  boolean symbolLib = false;
  boolean symbolLib2 = false;
  boolean emojiLib = false;
